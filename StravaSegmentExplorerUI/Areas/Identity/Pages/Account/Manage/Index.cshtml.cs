...
namespace StravaSegmentExplorerUI.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            //if (_sqlOperations.IsConnectedToStrava(userId))
            //{
            //    UserInfo = _sqlOperations.GetCurrentUserData(userId);
            //}
